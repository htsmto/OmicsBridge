                ...
                fluidRow(
                    ...
                    column(4, 
                        fluidRow(
                            ...
                            column(12, materialSwitch(ns('Expression_subtype_genes_from_custom_geneset'), 'Use the genes from the custom gene sets', value=FALSE, status='info') ),
    ...
    column(8, 
        box(width=12, title='Plot', status='danger', collapsible=TRUE,
            fluidRow(
                ...
                column(10, radioButtons(ns('Expression_subtype_figtype'), 'Figure type:', choices = c('Box plot'='A', 'Violin plot'='B', 'Swarm plot'='C', 'Violin + Swarm plot'='D'), selected='A', inline=TRUE) ),
                column(2,
                    dropdownButton( h4(strong("Plot Options")),
                        ...
                        fluidRow(
                            column(6, selectInput(ns('Expression_subtype_select_colour_pallete'), 'Choose a colour pallete',  c('None'='None', colour_pallets), selected = 'None'))
                        ),
                        fluidRow(
