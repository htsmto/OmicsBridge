            ...
            tabPanel(strong('Bar Plot'),
                ...
                column(2, 
                    ...
                    fluidRow(
                        ...
                        column(6, sliderInput(ns('Gene_ex_barplot_graph.title.font.size'), label='Graph title size', min=1, max=10, value=4, step=0.1)),
                    ...
                    fluidRow(
                        ...
                        column(6, materialSwitch(ns('show_outliers_rotate_x'), 'Rotate X axis label', value=TRUE, status = "success")),
