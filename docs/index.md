...
You can use OmicsBridge in a stand alone web interface at [https://omicsbridge.dkfz.de](https://omicsbridge.dkfz.de).
...
After logging in, run the Docker command as above on the remote server. Then, open `http://localhost:4191` in your local browser to access the app.
