...
ui <- fluidPage(
  ...
  dashboardPage(
    ...
    dashboardBody(
      ...
      tabItems(
        #### Home ####
          tabItem( tabName='home',
            ...
            #   HTML("
            #     <p>
            #     <h2> Please help me design a cool name and a cool website layout!!! </h2>
            #     </p>                
            #   ")
            
            # ),
            # box(width=12, title='Interface overview',
            #   solidHeader = TRUE, 
            #   status = "primary",
            #   tags$img(src = "interface_overview.png", class='responsive-img')
            # ),
            uiOutput("home_md")
          ),
        #### Database ####
          tabItem( tabName='Database',
            ...
            box(width=12,  collapsible=TRUE, title='Data upload',status='primary',
              ...
              fluidRow( column(3, selectInput('upload_Data_Class', 'Data Class *', c('Count data/Expression matrix'='A', 'Comparison data (ex. differential gene expression data from RNAseq, any table contain log fold change velues)'='B', 'single cell RNA'='C' ))), 
                conditionalPanel(
                    ...
                    ####### swarm plot #######  
                      tabPanel("Swarm plot", 
                        ...
                        box(title='Plot option', collapsible=TRUE,  width=12, collapsed = TRUE,
                          fluidRow(
                            column(4, sliderInput(inputId = 'Data_Overview_Swarm_fig.width', label='fig width', min=300, max=3000, value=500)),
                            column(4, sliderInput(inputId = 'Data_Overview_Swarm_fig.height', label='fig height', min=300, max=3000, value=500)),
                            column(4, sliderInput(inputId = 'Data_Overview_Swarm_pt.size', 'Point size', min=1, max=10, value=5)),
                            column(4, sliderInput(inputId = 'Data_Overview_Swarm_xlab.font.size', label='X label size', min=1, max=20, value=10)),
                            column(4, sliderInput(inputId = 'Data_Overview_Swarm_ylab.font.size', label='Y label size', min=1, max=20, value=10)),
                            column(4, sliderInput(inputId = 'Data_Overview_Swarm_graph.title.font.size', 'Graph title font size', min=1, max=40, value=10))
                          ),
                          fluidRow(
                      ...
                      tabPanel("Heatmap", 
                        box(collapsible=TRUE, status='primary', width=12,
                          fluidRow(
                            column(3, 
                              fluidRow(
                                column(12, radioButtons('Data_Overview_heatmap_target_gene_type', 'Genes from', choices = c('Text input'='A', 'Custom Gene Sets'='B', 'HALLMARK (Human)'='C', 'HALLMARK (Mouse)'='D', 'input a gmt file'='E'), selected='Text input')),
                            ...
                            column(9, 
                              fluidRow(
                                column(5, sliderInput(inputId = 'Cluster_num', label='Cluster number', min=1, max=20, value=1))
                              ),
                        ...
                        box(title='Plot options', collapsible=TRUE, status='primary', width=12, collapsed=TRUE,
                          fluidRow(
                            ...
                            column(6, sliderInput(inputId = 'Data_Overview_heatmap_xlab.font.size', label='X label size', min=1, max=20, value=6)),
                            column(6, sliderInput(inputId = 'Data_Overview_heatmap_ylab.font.size', label='Y label size', min=1, max=20, value=10)),
                    ...
                    ####### PCA ####### 
                      tabPanel("PCA plot",
                        ...
                        box(width=8, title='Plot options', collapsible = TRUE, collapsed = TRUE,
                          ...
                          fluidRow(
                            column(6, sliderInput(inputId = 'Data_Overview_PCA_xy.font.size', label='X/Y label size', min=10, max=40, value=15)),
                            column(6, sliderInput(inputId = 'Data_Overview_PCA_xy.title.size', label='Y/Y title size', min=10, max=40, value=20))
                          ),
                          fluidRow(
                            column(4, sliderInput(inputId = 'Data_Overview_PCA_point_size', 'Points size', min=1, max=20, value=5)),
                            column(4, sliderInput(inputId = 'Data_Overview_PCA_label_size', 'Sample label side', min=1, max=20, value=3)),
                            column(4, sliderInput(inputId = 'Data_Overview_PCA_legend_size', 'Legend size', min=10, max=40, value=15))
                          ),
                          fluidRow(
                  ...
                  tabsetPanel(
                    ...
                    ####### Plot #######  
                      ...
                      box( title='Main Plot Graph Options',  collapsible=TRUE, status='primary',width=12, collapsed=TRUE,
                        fluidRow(
                          column(4,sliderInput('fig.width', 'Fig width', min=300, max=3000, value=500)),
                          column(4,sliderInput('fig.height', 'Fig height', min=300, max=3000, value=500)),
                          column(4, sliderInput('pt.size', 'Point size', min=0.1, max=10, value=1))
                        ),
                        fluidRow(
                          column(4, sliderInput('high.pt.size', 'Highlighted points size', min=0.1, max=10, value=3, step=0.1)),
                          column(4, sliderInput('high.label.size', 'Highlighted labels size', min=1, max=20, value=5, step=1))
                        ),
                        fluidRow(
                          column(4, sliderInput('label.font.size', 'X/Y label font size', min=1, max=40, value=10)),
                          column(4, sliderInput('title.font.size', 'X/Y title font size', min=1, max=40, value=10)),
                          column(4, sliderInput('graph.title.font.size', 'Graph title font size', min=1, max=40, value=10))
                        )
                      ),
                      # Downstream analysis
                      box( title='Downstream analysis', collapsible=TRUE, status='primary',  width=12, collapsed=TRUE,
                        ## GO
                        box( title='GO analysis', collapsible=TRUE, status='primary', collapsed=TRUE, width=12,
                          box(title='Settings', collapsible=TRUE, width=4,
                            ...
                            box(title='Plot options',collapsible=TRUE, width=12, collapsed = T,
                              ...
                              fluidRow(
                                column(12, sliderInput('GO_fig.category_show_number','Number of categories to show', min=5, max=50, value=10)),
                                column(12, sliderInput('GO_xtitle.font.size', 'X title font size', min=10, max=60, value=20))
                              ),
                              fluidRow(
                        ...
                        ## GSEA
                        box( title='GSEA analysis', collapsible=TRUE, status='primary', width=12, collapsed=TRUE,
                          box(width=12, collapsible=TRUE, title='Settings',
                            fluidRow(
                              column(5,
                                fluidRow(
                                  column(5, radioButtons("GSEA_pathway_dataset_select", "pathways from:", choices = c("Custom Gene sets"='A', "HALLMARK (human)"='B', "HALLMARK (mouse)"='C', "Upload a gmt file (other gene sets)"='D'), selected="HALLMARK (human)")),
                              ...
                              column(7,
                                box(title='Plot options',collapsible=TRUE, width=12,  collapsed=TRUE,
                                  fluidRow(
                                    column(4, sliderInput('GSEA_fig.width', 'Fig width', min=300, max=3000, value=500)),
                                    column(4, sliderInput('GSEA_fig.height','Fig height', min=300, max=3000, value=500))
                                  ),
                                  fluidRow(
                                    column(4, sliderInput('GSEA_lab.font.size', 'X/Y labels size', min=1, max=30, value=15, step=1)),
                                    column(4, sliderInput('GSEA_title.font.size', 'X/Y title font size', min=1, max=40, value=20)),
                                    column(4, sliderInput('GSEA_graph_title.font.size', 'Graph title font size', min=1, max=40, value=15))
                                  )
                                )
                              )
                            )
                        ...
                        ## DcoupleR
                        box( title='TF activity inference (DecoupleR analysis. Available only for RNAseq DEG data processed from DESeq2)', collapsible=TRUE, stats='primary', width=12, collapsed=TRUE,
                          box(title='Settings', collapsible=TRUE, width=4,
                            fluidRow(column(12, sliderInput('DecoupeR_TF_number', 'Number of TF to display', min=10, max=200, value=50, step=2))),
                            h3(),
                            ...
                            box(width=12, title="Plot options", collapsible = TRUE, collapsed = TRUE,
                              ...
                              fluidRow(
                                ...
                                column(12, sliderInput('DecoupeR_title.font.size', 'X/Y title font size', min=1, max=40, value=20)),
                              ),
                              fluidRow(
              ...
              tabsetPanel(
                ...
                tabPanel("Get the overlap",
                  ...
                  box(width=12, collapsible=TRUE, title='Plot options', collapsed=TRUE,
                    fluidRow(
                      column(4,sliderInput('Compare_dataset_get_overview_fig.width', 'Fig width', min=300, max=3000, value=500)),
                      column(4,sliderInput('Compare_dataset_get_overview_fig.height', 'Fig height', min=300, max=3000, value=500)),
                    ),
                    fluidRow(
                ...
                tabPanel("Compare one gene",
                  ...
                  box(width=8, collapsible=TRUE, title='Plot options', collapsed=TRUE,
                    fluidRow(
                      column(4,sliderInput('Compare_fig.width', 'Fig width', min=300, max=3000, value=500)),
                      column(4,sliderInput('Compare_fig.height', 'Fig height', min=300, max=3000, value=500)),
                      column(4, sliderInput('Compare_pt.size', 'Point size', min=0.1, max=10, value=3))
                    ),
                    fluidRow(
                      column(4, sliderInput('Compare_label.font.size', 'X/Y label font size', min=1, max=40, value=15)),
                      column(4, sliderInput('Compare_title.font.size', 'X/Y title font size', min=1, max=40, value=15)),
                      column(4, sliderInput('Compare_graph.title.font.size', 'Graph title font size', min=1, max=40, value=15))
                    ),
                    fluidRow(
            ...
            box(width=12, title='Data exchanging', collapsible=TRUE, 
              ...
              box(width=6, title='Data1',
                  ...
                  box(title='Gene selection', collapsible=TRUE, width=12,
                    fluidRow(
                      ...
                      conditionalPanel(
                        ...
                        column(4, 
                          fluidRow(
                            column(12, sliderInput('Integrate_data1_x_threshold', 'The threshold for X axis', min=0, max=15, value=1, step=0.2)),
                ...
                box(title='Figure option', collapsible=TRUE, width=12, collapsed=TRUE,
                  fluidRow(
                    column(6,sliderInput('Integrate_data1_fig.width', 'Fig width', min=300, max=3000, value=500)),
                    column(6,sliderInput('Integrate_data1_fig.height', 'Fig height', min=300, max=3000, value=500)),
                  )
                )
              ),
              box(width=6, title='Data2',
                  ...
                  box(title='Gene selection', collapsible=TRUE, width=12,
                    fluidRow(
                      ...
                      conditionalPanel(
                        ...
                        column(4, 
                          fluidRow(
                            column(12, sliderInput('Integrate_data2_x_threshold', 'The threshold for X axis', min=0, max=15, value=1, step=0.2)),
                ...
                box(title='Figure option', collapsible=TRUE, width=12,  collapsed=TRUE,
                  fluidRow(
                    column(6,sliderInput('Integrate_data2_fig.width', 'Fig width', min=300, max=3000, value=500)),
                    column(6,sliderInput('Integrate_data2_fig.height', 'Fig height', min=300, max=3000, value=500)),
                  )
                )
              ),
              box(width=12, title='Overlap genes',
                fluidRow(
                  column(4, sliderInput('Integrate_data_mapped_x_threshold', 'The threshold for X axis (mapped side)', min=0, max=15, value=1, step=0.2)),
                  column(4, sliderInput('Integrate_data_mapped_y_threshold', 'The threshold for Y axis (mapped side)', min=0, max=15, value=1, step=0.2)),
                ...
                tabsetPanel(
                  ...
                  ###### Survival analysis ######
                    tabPanel("Survival analysis",
                      box(width=12,
                        fluidRow(
                          column(3, textAreaInput('Clinical_Survival_genes', 'Enter genes')),
                          column(3, radioButtons('Clinical_Survival_Split_way', 'Split the samples by:', choices = c('Median'='A', 'Top 25% vs Bottom 25%'='B'))),
                      ...
                      box(width=12,
                        fluidRow(
                          column(4, 
                            ...
                            DT::dataTableOutput("Clinical_Survial_table"),
                            downloadButton('Clinical_Survial_table_download',"Download this table")
                          ),
                          column(8, h4('Kaplan-Meier curve'), verbatimTextOutput('Clinical_Survial_plot_error_catch'), plotOutput("Clinical_Survial_plot", width="100%", height="100%")),
                        )
                      ),
                      box(width=12, title='Graph options', collapsible = TRUE, collapsed = T,
                        ...
                        fluidRow(
                          column(2, colourInput('Clinical_Survial_High_colour', 'Colour for the "High" group:', value='#ec00ec')),
                          column(2, colourInput('Clinical_Survial_Low_colour', 'Colour for the "Low" group:', value='#00aaff')),
                        )
                      )
                    ),
                  ###### Gene correlation ######
                    tabPanel("Gene correlation",
                      box(width=12, 
                        fluidPage(
                          column(3, textAreaInput('Gene_correlation_genes', 'Enter ONE gene')),
                          column(3, radioButtons('Gene_correlation_Corralation_method', 'Method for correlation', choices = c('pearson', 'spearman'))),
                          column(2, 
                      ...
                      box(width=12, title='Graph options', collapsible = TRUE, collapsed = T,
                        fluidRow(
                          column(4,sliderInput('Gene_correlation_fig.width', 'Fig width', min=300, max=3000, value=700, step=10)),
                          column(4,sliderInput('Gene_correlation_fig.height', 'Fig height', min=300, max=3000, value=700, step=10)),
                        ),
                        fluidRow(
                          column(4,sliderInput('Gene_correlation_label_size', 'X/Y label size', min=10, max=40, value=20, step=1)),
                          column(4,sliderInput('Gene_correlation_title_size', 'X/Y title size', min=10, max=40, value=20, step=1)),
                        ),
                        fluidRow(
                    ...
                    tabPanel("Gene expression acrosss subtype",
                      box(width=12,
                        fluidRow(
                          ...
                          column(2, radioButtons('Expression_subtype_figtype', 'Figure type:', choices = c('Box plot'='A', 'Violin plot'='B', 'Swarm plot'='C', 'Violin + Swarm plot'='D'), selected='Box plot'))
                        )
                      ),
                      box(width=12,
                        fluidRow(
                          column(4, h4('Test Results'),  
                            ...
                            DT::dataTableOutput("Expression_subtype_table"),
            ...
            box(width=12, title='Data Overview',
              box(width=12, title='Umap plot', collapsible = TRUE, status = 'primary',
                fluidRow(
                  ...
                  column(4,
                    box(width=12, title='Plot options', collapsible = TRUE, collapsed = TRUE,
                      sliderInput('scRNA_umap1_fig.width', 'Fig width (Data overview)', min=300, max=3000, value=500),
                      sliderInput('scRNA_umap1_fig.height', 'Fig height (Data overview)', min=300, max=3000, value=500)
                    )
                  )
                )
              ),
            ...
            box(width=12, title='Other plots', collapsible = TRUE, collapsed = TRUE,
              ...
              box(width=12, title='Gene expression across groups', collapsible = TRUE, status = 'primary',
                fluidRow(
                  column(8,
                    fluidRow(
                      column(3, textAreaInput("scRNA_VlnPlot_gene", "Enter genes name")),
                  ...
                  column(4,
                    box(width=12, title='Plot options', collapsible = TRUE, collapsed = TRUE,
                      column(12,sliderInput('scRNA_vln_fig.width', 'Fig width', min=300, max=3000, value=1000)),
                      column(12,sliderInput('scRNA_vln_fig.height', 'Fig height', min=300, max=3000, value=500)),
              ...
              box(width=12, title='Fraction of the cells expressing a gene', collapsible = TRUE, status = 'primary',
                fluidRow(
                  column(8,
                    fluidRow(
                      column(2, textAreaInput("scRNA_fraction_gene", "Enter genes name")),
                  ...
                  column(4,
                    box(width=12, title='Plot options', collapsible = TRUE, collapsed = TRUE,
                      column(12,sliderInput('scRNA_fraction_fig.width', 'Fig width', min=300, max=3000, value=1000)),
                      column(12,sliderInput('scRNA_fraction_fig.height', 'Fig height', min=300, max=3000, value=500)),
      ...
      h4(tags$div("Last updated on 14th. Feb, 2025 ", style = "text-align: right;"))
    )
  )
)
...
server <- function(input, output, session) {
  ...
  ### Information Tab ##############################################################################
    ...
    #### Show the data list ####
      ...
      output$DataBaseTable <- DT::renderDataTable({ 
        ...
        data_table_tmp <- data_table_tmp[,c( "Dataset", "Data.type", "CellLine", "Data.from", "When", 'Experiment', 'Control.group', 'Treatment.group', "Description")] 
    ...
    #### Data Table ####
      ...
      ##### Plot #####
            ...
            if(is.null(input$Dataset_select) || input$Dataset_select=='None'){
              ...
              if(!is.null(df_tmp)){
                if(input$order_group){
                  df_tmp <- df_tmp[df_tmp$Group %in% unlist(strsplit(input$group_order, split = "\n")),]
                  df_tmp$Group <- factor(df_tmp$Group, levels = c(unlist(strsplit(input$group_order, split = "\n"))))
                } 
        ...
        ###### TF activity inference (DecoupleR) ######
          ...
          output$DecoupeR_plot_status <- renderText({'Please make sure this is only applicable to the RANseq DEG data processed by DESeq2.'})
      ...
      ##### plot
        ...
        output$Integrate_data2_plot <- renderPlot({
          if(input$Integrate_data2_Scat.X == 'None' |  input$Integrate_data2_Scat.Y== 'None'){
            ...
            if(input$Integrate_data_map_direction == 'A'){ plot_scatter_plot(df_data2(), input$Integrate_data2_Scat.X, input$Integrate_data2_Scat.Y, data1_outliers(), input$Integrate_data_mapped_x_threshold, input$Integrate_data_mapped_y_threshold,  input$Integrate_data1_Direction, 1) }
    ...
    #### generate UMAP
      ...
      output$scRNA_UMAP1 <- renderPlot({
        if(is.null(input$scRNA_UMAP1_groupBy) || input$scRNA_UMAP1_groupBy == 'None'){
          ...
          p <- DimPlot(Seurat_obj(),reduction = "umap",group.by = c(input$scRNA_UMAP1_groupBy))
          p
        }
      ...
      ##### Calculate the correlation #####
        df_gene_correlation <- eventReactive(input$Gene_correlation_start, {
          ...
          if(nchar(input$Gene_correlation_genes)==0){
            output$Gene_correlation_error_catch <- renderText({'Please enter a gene name.'})
            return(NULL)
          }
          ...
          for ( gene2 in rownames(df_geneEx)){
      ...
      ##### Plot the correlation by a scatter plot #####
        ...
        output$Gene_correlation_scatter_plot <- renderPlot({
          if(is.null(df_gene_correlation())){
            ...
            if(length(input$Gene_correlation_table_rows_selected)>0){
              ...
              Gene1 <- df_gene_correlation()$target[1]
              Gene2 <- df_gene_correlation()[input$Gene_correlation_table_rows_selected,]$Gene
              df_geneEx <- Clinical_gene_expression()
        ...
        output$Gene_correlation_table_download <- downloadHandler(
          ...
          content = function(fname){ write.table(df_gene_correlation(), fname, sep='\t', row.names=F, quote=F) }
                          ...
                          # fluidRow(
                          #   column(4,sliderInput('Gene_correlation_fig.width', 'Fig width', min=300, max=3000, value=500, step=10)),
                          #   column(4,sliderInput('Gene_correlation_fig.height', 'Fig height', min=300, max=3000, value=500, step=10)),
                          # ),
                          # fluidRow(
                          #   column(4,sliderInput('Gene_correlation_label_size', 'X/Y label size', min=3, max=30, value=10, step=1)),
                          #   column(4,sliderInput('Gene_correlation_title_size', 'X/Y title size', min=3, max=30, value=10, step=1)),
                          # ),
                          # fluidRow(
                          #   column(3, colourInput('Gene_correlation_colour', 'Colour for the "High" group:', value='#ec00ec')),
                          #   column(2, checkboxInput('Gene_correlation_show_correlation_line', 'Colour for the "Low" group:')
  ...
  ### Tools 
    #### human to mouse, mouse to human
                  ...
                  # fluidRow(
                  #   column(3, radioButtons("human_mouse_convert_direction", "Human <=> Mouse direction", choices = c('Convert mouse genes to human genes' = 'A', 'Convert human genes to mouse genes' = 'B'), selected='A')),
                  #   column(3, radioButtons("human_mouse_convert_input_type", "Input type", choices = c('Gene symbol' = 'A', 'Ensembl gene id' = 'B', 'Ensembl gene id (with version)' = 'C'), selected='A'))
                    # column(2, radioButtons("human_mouse_convert_output_type", "Output type", choices = c('Gene symbol' = 'A', 'Ensembl gene id' = 'B', 'Ensembl gene id (with version)' = 'C'), selected='A'))
                  # ),
                  #   fluidRow(
                  #     column(5, textAreaInput('human_mouse_convert_input_gene', 'Enter genes (line by line)')),
    ...
    ### convert Ensembl to Gene symbol
                    # fluidRow(
                    #   column(2, radioButtons("Gene_Ensembl_spieces", "Species", choices=c("Human", "Mouse"), selected="Human")),
                    #   column(2, radioButtons("Gene_Ensembl_input_type", "Input type", choices = c('Gene symbol' = 'A', 'Ensembl gene id' = 'B', 'Ensembl gene id (with version)' = 'C'), selected='B')),
                    #   column(2, radioButtons("Gene_Ensembl_output_type", "Output type", choices = c('Gene symbol' = 'A', 'Ensembl gene id' = 'B', 'Ensembl gene id (with version)' = 'C'), selected='A'))
                    # ),
                    # fluidRow(
